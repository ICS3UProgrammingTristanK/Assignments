...
namespace BlackJack21a
{
    class RandomNumber
    {
        private static readonly System.Security.Cryptography.RNGCryptoServiceProvider _seed = new
        ...
        public static int NumberBetween(int minimum, int maximum)
        {
            ...
            return (int)(minimum + randomValue); // add minvalue to randomvalue(0 to max)
        }
    } // End RandomNumber
}